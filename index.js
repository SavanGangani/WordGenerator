...
function words(options) {
  ...
  function word() {
    ...
    } else if( options && options.fixedLegnth && options.numberOfWords > 0) {
      return generateFixedLengthWord(options.fixedLegnth, options.numberOfWords)
    } 
    else {
...
module.exports = {words, generateFixedLengthWord};
